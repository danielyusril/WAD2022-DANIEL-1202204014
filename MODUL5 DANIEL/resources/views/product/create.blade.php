    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="/product/layout.blade.php">Home</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container py-5">
            ...
            <form method="post" action="../config/insert.php" enctype="multipart/form-data">
                ...
                <input type="text" id="pemilik" class="form-control mb-3" name="pemilik" value="Daniel Yusril Jasli - 1202204014" readonly>
